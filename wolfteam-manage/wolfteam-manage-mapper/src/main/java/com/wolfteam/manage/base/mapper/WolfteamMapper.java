package com.wolfteam.manage.base.mapper;
...
public interface WolfteamMapper<T> {
     ...
     * @return
     */
    @DeleteProvider(type = WolfteamMapperProvider.class, method = "dynamicSQL")
     ...
     * @return
     */
    @SelectProvider(type = WolfteamMapperProvider.class, method = "dynamicSQL")
     ...
     * @return
     */
    @InsertProvider(type = WolfteamMapperProvider.class, method = "dynamicSQL")
    int insert(T record);
     ...
     * @return
     */
    @UpdateProvider(type = WolfteamMapperProvider.class, method = "dynamicSQL")
