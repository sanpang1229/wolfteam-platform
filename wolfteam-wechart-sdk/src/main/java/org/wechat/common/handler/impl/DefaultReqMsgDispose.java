...
import org.wechat.common.entity.req.BasicMsg;
...
import org.wechat.common.handler.ReqMsgHandler;
...
public abstract class DefaultReqMsgDispose implements ReqMsgHandler {
	...
	public String DefaultMsgDisPose(InputStream input) throws DocumentException, IOException{
		...
		if(input!=null){
			...
			if(params!=null&&params.size()>0){
				...
				RespBasicMsg msg =MsgDispose(msgInfo,params,handler);
	 ...
	 * @return
	 */
	public RespBasicMsg MsgDispose(BasicMsgUserInfo msg, Map<String, String> params,BasicXmlHandler handler) {
		RespBasicMsg result=null;
