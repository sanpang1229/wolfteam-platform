package org.wechat.msg.templet;
...
public class LogisticsThemple extends MessageConn{
	 ...
	 *  您好，您的订单包裹已被您拒收
		...
		如有疑问，请联系我们
	 */
	public MsgResult TOrderPackgerTrack(String accessToken,String openid,String templeId,String url,String TopColor,String ContnetColor,String title,String orderId,String packgeId,String playementInfo,String carrierInfo,String receiver,String remark){	
	 ...
	 */
	public MsgResult TOrderStateChanage(String accessToken,String openid,String templeId,String url,String TopColor,String ContnetColor,String orderNumber,String status,String remark){	
		MsgResult result = null;
		TreeMap<String,TreeMap<String,String>> mremark1 = new TreeMap<String,TreeMap<String,String>>();
	 ...
	 */
	public MsgResult TOrderStateConsigneeState(String accessToken,String openid,String templeId,String url,String TopColor,String ContnetColor,String channel,String orderNumber,String status,String sometimes,String remark){
		MsgResult result = null;
	 ...
	 */
	private MsgResult getCommonParams(String accessToken,String openid,String templeId,String url,String topColor,TreeMap<String,TreeMap<String,String>> methodParams){
		MsgResult result = null;
