...
public class EventProcessor extends AbstractCompositeProcess {
        ...
        protected static final Logger log = LoggerFactory.getLogger(EventProcessor.class);
	...
	public void actualProcess(InstructionObject io) {
		...
		case scancode_waitmsg:
		    System.out.println("带提示的扫描事件---");
		    event_scancode_waitmsg(io);
			break;
		case pic_sysphoto:
			break;
	...
	private void event_scancode_waitmsg(InstructionObject io) {
